...
public class cj17_frogJump {
	...
	public static void main(String[] args) {
		...
		System.out.println("The minmum number is: " + solution(X, Y, D));
	...
	public static int solution(int X, int Y, int D) {
		...
		int minNumber = 0;
		int distance = X;
// The following code is scored as 44%
//		while (distance < Y) {
//			distance = distance + D;
//			minNumber++;
//		}
...
//		System.out.println("The minmum number is: " + minNumber);
